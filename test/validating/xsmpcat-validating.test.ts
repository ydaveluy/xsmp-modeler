...
describe('Validating', () => {
 ...
 [30:1..30:19]: Duplicated annotation of a non-repeatable type. Only annotation types marked with \`@allowMultiple\` can be used multiple times on a single target.
 [31:1..31:19]: This annotation is disallowed for element of type PrimitiveType.
 [30:1..30:19]: A value is required.
 [3:9..3:21]: Invalid date format (e.g: 1970-01-01T00:00:00Z).
 [32:1..32:10]: Missing Type UUID.
 ...
 [53:14..53:50]: Duplicated UUID.
 [57:14..57:50]: Duplicated UUID.
 [61:14..61:22]: The UUID is invalid.
 ...
 [91:4..91:9]: The Model shall be abstract.
        `);
    });
